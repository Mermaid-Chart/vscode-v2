...
import styles from './update-diagram.module.css';
import {
  VSCodeButton,
  VSCodeTextField,
...
const UpdateDiagram = () => {
  const [diagramCode, setDiagramCode] = useState<string | undefined>('');
  ...
  const handleDiagramData = (data: string) => {
    ...
    setDiagramCode(parsedData.code);
    setDiagramTitle(parsedData.title);
  };
        ...
        <div>
          <VSCodeTextField
            ...
            onChange={(event) => {
              ...
              setDiagramTitle(inputElement.value || '');
            }}
          />
          <Editor
            height="85vh"
